    ...
    <div id="classroom">
        <header>
            <div class="classroomDiv">
                <img src="/resources/img/lesson/thumb/${lesson.teacherId}${lesson.openAt}/${lesson.thumbnail}" alt="클래스 썸네일">
            </div>
                ...
                <div id="teacherInfo" class="introDIV">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <a href="//${teacher.snsUrl}">${teacher.snsId}</a></td>
                        </tr>
                        <tr>
                    ...
                    <div class="calendar">
                        <div class="col rightCol">
                            <div class="content">
                                <h2 class="year"></h2>
                                <ul class="months">
                                    <li><a href="#" class="moveBtn"><i class="xi-angle-left-min"></i></a></li>
                                    ...
                                    <li><a href="#" class="moveBtn"><i class="xi-angle-right-min"></i></a></li>
                                </ul>
            ...
            let str = "";
                for (var j = 0; j < pageYear[first.getMonth()]+first.getDay(); j++) {
                    if (j < first.getDay() || cnt > pageYear[first.getMonth()]) {
                        ...
                        str+='<li><a href="#" data-value="'+cnt+'">'+cnt+'</a></li>';
                        cnt++;
                    }
                }
                ...
                for(var i = 0; i<scheduleList.length; i++) {
                	...
                	if(today.getFullYear()==scheduleYear){
                		...
                		if(((first.getMonth()+1).length==1?"0"+first.getMonth()+1:first.getMonth()+1)==scheduleMonth){
                    		var scheduleDay = scheduleTmp[2];
                    			if(scheduleDay.indexOf(0)=='0'){
                    				scheduleDay = scheduleDay.replace('0','');
                    			}
                    			var scheduleDate = $(".days li a[data-value='"+scheduleDay+"']")
                    			scheduleDate.addClass("selected");
                    			scheduleDate.attr("title", startAt.val()+"~"+endAt.val());
                		}
                	}
                }
