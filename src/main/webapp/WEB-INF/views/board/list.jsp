				...
				<form id='actionForm' action="/board/list" method='get'>
					<select class="form-control search" id='type' name='type'>
						...
						<option value="TWC"
							...
							or 내용 or 작성자</option>
					</select> <input class="form-control searchInput" type='text' id='keyword'
					...
					<input type='hidden' id='pageNum' name='pageNum'
						...
						value='<c:out value="${pageMaker.cri.typeId }"/>' />
				...
				.ready(
						function() {
							...
							$("#writeBtn").on(
									"click",
									function() {
										self.location = "/board/write?typeId="
												+ $typeId.val();
									});
